...
cat $HOME/.fusiond/config/genesis.json | jq '.app_state["identity"]["keyrings"]=[{"address": "qredokeyring1ph63us46lyw56vrzgaq", "is_active": true, "creator": "qredo1d652c9nngq5cneak2whyaqa4g9ehr8psyl0t7j", "description": "ACME corp", admins: ["qredo1d652c9nngq5cneak2whyaqa4g9ehr8psyl0t7j"], parties: ["qredo1d652c9nngq5cneak2whyaqa4g9ehr8psyl0t7j"], fees: [key_req: "1", sig_req: "1"]}]' > $HOME/.fusiond/config/tmp_genesis.json && mv $HOME/.fusiond/config/tmp_genesis.json $HOME/.fusiond/config/genesis.json
